...
import { parseMsdsSection3 } from "@/lib/parsing/section3";
...
export async function POST(request: Request) {
  ...
  let draftIngredients: Awaited<ReturnType<typeof parseMsdsSection3>> = [];
  try {
    draftIngredients = await parseMsdsSection3(buffer);
  } catch (err) {
